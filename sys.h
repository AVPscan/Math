...
typedef struct { MatBuf Ho, Sr, Lo; anu lb, Nim, Over, l, cl, C, F, N, Fre, Nre,
  lre, fa, fb, na, nb, dr, da, db, *r, *a, *b, *re, *R, *A, *B, *RE; } Cache; extern Cache Mat;
void _MatInit (anu c, anu *a);
