...
* **Нет предела**: Существует мнение что число атомов во вселенно примерно 10^80 это 266 бит = 34 атома, теперь доступно 256 но настоятельно рекомендую ограничиться 128 атомами чтоб умножая такие числа не вылетать в переполнение ибо это не имеет смысла.
