...
int main(void) {
    ...
    FADD(Mat.Long, (anu*)&ra, (anu*)&o1.h, (anu*)&o2.h); if (!BE) { FBSWAP(Mat.Long, (anu*)&ra, (anu*)&ra); } printf("%d + %d = %d\n", a, b, ra);
    FSUB(Mat.Long, (anu*)&rs, (anu*)&o1.h, (anu*)&o2.h); if (!BE) { FBSWAP(Mat.Long, (anu*)&rs, (anu*)&rs); } printf("%d - %d = %d\n", a, b, rs);
    FMUL(Mat.Long, (anu*)&rm, (anu*)&o1.h, (anu*)&o2.h); if (!BE) { FBSWAP(Mat.Long * 2, (anu*)&rm, (anu*)&rm); } printf("%d * %d = %d\n", a, b, rm); Mat.Carry = 0;
    Mat.Nim = 1; FADD(Mat.Long, (anu*)&za, (anu*)&o3.h, (anu*)&o4.h); if (!BE) { FBSWAP(Mat.Long, (anu*)&za, (anu*)&za); } printf("%d + %d = %d\n", c, d, za);
    FSUB(Mat.Long, (anu*)&zs, (anu*)&o3.h, (anu*)&o4.h); if (!BE) { FBSWAP(Mat.Long, (anu*)&zs, (anu*)&zs); } printf("%d - %d = %d\n", c, d, zs);
    FMUL(Mat.Long, (anu*)&zm, (anu*)&o3.h, (anu*)&o4.h); if (!BE) { FBSWAP(Mat.Long * 2, (anu*)&zm, (anu*)&zm); } printf("%d * %d = %d\n", c, d, zm);
    return 0; }
