...
void FSWAP(an r, an a, anu l);                  // Зеркалирование атомов относительно центра числа
...
void FCOLD(an r, an a, anu l);                  // Приведение к формату l = 1,2,4,8,16,32,64,128,256 атомов
