...
// Mat.R{E{A{B}}} Mat.Nim, Mat.V и Mat.Be не подлежат изменению внутри функций
...
typedef struct { MatBuf Li, Hi; anu Nim, V, Be, // Структура реализации библиотеки {proc cache}
